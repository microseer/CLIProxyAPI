...
<body>
    <div class="container">
        ...
        <div class="auth-methods">
            ...
            <a href="/v0/oauth/kiro/start?method=google" class="auth-btn google">
                <span class="icon">G</span>
                Google OAuth
            </a>
            
            <a href="/v0/oauth/kiro/start?method=github" class="auth-btn github">
                <span class="icon">🐙</span>
                GitHub OAuth
            </a>
        ...
        <div class="warning-box">
            ⚠️ <strong>Note:</strong> Google and GitHub login use Kiro's social OAuth flow. If your environment blocks browser callbacks, use AWS Builder ID or import a token from Kiro IDE.
        </div>
